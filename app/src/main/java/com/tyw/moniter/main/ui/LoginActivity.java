...
import com.tyw.moniter.utils.InputMethodUtils;
...
public class LoginActivity extends AppCompatActivity /*implements LoaderCallbacks<Cursor>*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mSignInButton = findViewById(R.id.btn_login_attempt);
        ...
        mLoginFormView = findViewById(R.id.frame_login_form);
...
//            Snackbar.make(mEditUserName, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
...
//            mEditUserName.setError(getString(R.string.error_invalid_email));
//            focusView = mEditUserName;
//            cancel = true;
//        }
        ...
        if (cancel) {
            ...
            imm.hideSoftInputFromWindow(mEditUserName.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
