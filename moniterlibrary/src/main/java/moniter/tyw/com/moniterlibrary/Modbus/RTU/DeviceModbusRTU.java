...
public class DeviceModbusRTU extends Device {
    // Ethernet
    ...
    protected DeviceModbusRTU(long _lPtr, int _index, int _state, String _name, String _description, String _id, String _ip,
    ...
    public DeviceModbusRTU(Channel _channel) {
        super(_channel);
    }
    ...
    public String GetViewIPAddress() {
        return new StringBuilder("IPAddress:    ").append(strIPAddress).toString();
    }
    ...
    public String GetViewKeyString() {
        ...
        return builder.append(strIPAddress).append(":").append(nPort).append("[").append(nSlaveID).append("]").toString();
    }
    ...
    public String GetViewDetailString() {
        ...
        builder.append("通讯协议:   Modbus串口网络流转发");//.append(System.getProperty("line.separator"));
        //builder.append(strIPAddress).append(System.getProperty("line.separator"));
